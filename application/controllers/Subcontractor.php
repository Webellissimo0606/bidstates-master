...
class Subcontractor extends CI_Controller {
    ...
    function dashboard()
    {
       ...
       // $page_data['page_title'] = get_phrase('subcontractor_dashboard');
	   
	   $page_data['page_title'] = "SubContractor Dashboard";
		//get value from db :-
		
		$credential = array('subcontractor_id' => $this->session->userdata('login_user_id'));
        ...
        if ($query->num_rows() > 0) {
			...
			$user_info["subcontractor_id"]=$row->subcontractor_id;
	...
	function profile()
    {
       ...
       // $page_data['page_title'] = get_phrase('contractor_dashboard');
		$page_data['page_title'] = "SubContractor Profile";
		//get value from db :-
