...
<html lang="en">
    ...
    <body class="nav-md">
                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="#" class="site_title"><i class="fa fa-paw"></i> <span>Triage - BidStates Admin</span></a>
                        </div>
                        ...
                        <div class="profile">
                            <div class="profile_pic">
                                <img src="https://www.crucial.com.au/blog/wp-content/uploads/2015/08/admin_blog_cover-e1439949752551.png" alt="..." class="img-circle profile_img">
                            </div>
                            ...
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    ...
                                    <li>
                                        ...
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>admin/accounts">View Contractors</a></li>
                                            <li><a href="<?php echo base_url(); ?>admin/addContractor">Add Contractors</a></li>
                                            <li><a href="<?php echo base_url(); ?>admin/customers">View Customers</a></li>
                                            <li><a href="<?php echo base_url(); ?>admin/addCustomer">Add Customers</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
        ...
        <?php if (isset($user_manager)) :?>
            <script src="<?php echo base_url();?>assets/js/jquery.validate.min.js"></script>
            <script src="<?php echo base_url();?>assets/js/bs-login.js"></script>
            <script src="<?php echo base_url();?>assets/js/bs-signup.js"></script>
        ...
        <?php if (isset($script)) :?>
            <script src="<?php echo base_url(); ?>assets/backend/<?php echo $script; ?>"></script>
        <?php endif;?>
        <script>
