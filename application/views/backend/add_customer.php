...
<form class="form-horizontal" method="post" role="form" id="form_signup">
    ...
    <fieldset>
        <div class="form-group required">
            <label class="col-md-12 control-label" style="text-align: center;">Create a Customer</label>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <button type="submit" class="btn btn-primary btn-block btn-signup">Create A Customer</button>
            </div>
        </div>
