...
<form class="form-horizontal" method="post" role="form" id="form_edit_user">
    ...
    <input type="hidden" name="user_id" value="<?= $user->contractor_id ?>" />
    <fieldset>
        <div class="form-group required">
            <label class="col-md-12 control-label" style="text-align: center;">Edit a Contractor</label>
        ...
        <div class="form-group required contractor-form">
            ...
            <div class="col-md-6">
                <input name="company-name" placeholder="Company Name" class="form-control input-md" required="" type="text" value="<?= $user->company_name ?>">
            </div>
        </div>
        <div class="form-group required contractor-form">
            <label class="col-md-4 control-label">Customer Name <sup>*</sup> </label>
            <div class="col-md-6">
                <input name="customer-name" placeholder="Customer Name" class="form-control input-md" required="" type="text" value="<?= $user->customer_name ?>">
            </div>
        </div>
        <div class="form-group required">
